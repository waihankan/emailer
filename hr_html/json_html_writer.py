...
<body>
    ...
    <div style="display: flex;"><div style="display: flex; margin:auto; background-color: #2f57be; border-radius: 15px; padding: 4px 9px;"><a href="https://discord.gg/sMfdX4Pvz5" target="blank"><img alt="discord" height="32" src="https://i.imgur.com/kvuAayt.png" style="display:block; height:auto; border:0;" title="Discord" width="32" /></a><a style="margin-left: 5px;padding-top: 6px;text-decoration: none; color: white; font-size: 14px;" href="https://discord.gg/sMfdX4Pvz1" target="blank">Join Our Discord Channel</a></div></div><div style=" font-family: 'Roboto' ; font-weight: 300; font-size: 13px; color: #7a7a7a; padding-top: 30px; padding-bottom: 35px;"><p style="margin: 3px;">Email: cookieacademy19@gmail.com</p><p style="margin: 3px;">Human Resource Department</p><p style="margin: 3px;">Cookie Academy © 2021</p></div></div></div></div></div></div>
</body>
</html>
"""
