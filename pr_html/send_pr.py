...
def confirm(applicants):
    ...
    if len(applicants) == 0:
        print(termcolor.colored("Please enter recipients in pr_applicants.csv", "red"))
    else:
        answer = ""
