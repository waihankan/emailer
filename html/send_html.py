...
<body style="box-sizing: border-box font-family:'Karla'"><div style="box-sizing:border-box; margin-left: auto; margin-right:auto; max-width:500px; background-color:#253a6d;"><img style="box-sizing: border-box; margin: auto; border: 0; display:block; max-width:500px; width:100%" src="https://i.imgur.com/3jmX19l.jpg" alt="cover" padding:0px>
    ...
    <div style="box-sizing: border-box; margin: auto; max-width:350px; text-align: center"><p style="font-size: 16px; font-family:'Poppins'; color: #f1dfb7">Thank you for applying for the position of <strong>Human Resource Manager</strong> with Cookie Academy.We would like to invite you to join the meeting to interview for the position. Click the button below to see your schedule.</p>
